...
/** 
 * FXPickingGraphMousePlugin supports the picking of graph elements
 ...
 * @author Tom Nelson
 */
public class FXPickingGraphMousePlugin<V, E> extends AbstractGraphMousePlugin
	 ...
	 */
	public FXPickingGraphMousePlugin() {
	 ...
	 */
    public FXPickingGraphMousePlugin(int selectionModifiers, int addToSelectionModifiers) {
     ...
     *
     */
    protected void pickContainedVertices(FXVisualizationViewer<V,E> vv, Point2D down, Point2D out, boolean clear) {
