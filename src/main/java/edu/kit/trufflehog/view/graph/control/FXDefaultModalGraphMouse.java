...
/** 
 * 
 * FXDefaultModalGraphMouse is a FXPluggableGraphMouse class that
 ...
 * @author Tom Nelson
 */
public class FXDefaultModalGraphMouse<V,E> extends FXAbstractModalGraphMouse
    implements FXModalGraphMouse, ItemSelectable {
    
    /**
     * create an instance with default values
     *
     */
    public FXDefaultModalGraphMouse() {
        this(1.1f, 1/1.1f);
    }
     ...
     */
    public FXDefaultModalGraphMouse(float in, float out) {
        super(in,out);
        loadPlugins();
    ...
    protected void loadPlugins() {
        ...
        add(scalingPlugin);
        setMode(FXModalGraphMouse.Mode.TRANSFORMING);
    }
    
    public static class ModeKeyAdapter extends KeyAdapter {
    	private char t = 't';
    	private char p = 'p';
    	protected FXModalGraphMouse graphMouse;

    	public ModeKeyAdapter(FXModalGraphMouse graphMouse) {
			this.graphMouse = graphMouse;
		}

		public ModeKeyAdapter(char t, char p, FXModalGraphMouse graphMouse) {
			this.t = t;
			this.p = p;
			this.graphMouse = graphMouse;
		}
        ...
        public void keyTyped(KeyEvent event) {
			...
			if(keyChar == t) {
				...
				graphMouse.setMode(FXModalGraphMouse.Mode.TRANSFORMING);
			} else if(keyChar == p) {
