 ...
 * @author Tom Nelson
 */
public class FXScalingGraphMousePlugin extends AbstractGraphMousePlugin
    ...
    public FXScalingGraphMousePlugin(ScalingControl scaler, int modifiers) {
        this(scaler, modifiers, 1.1f, 1/1.1f);
    }
    
    public FXScalingGraphMousePlugin(ScalingControl scaler, int modifiers, float in, float out) {
        super(modifiers);
        this.scaler = scaler;
        this.in = in;
        this.out = out;
   ...
   /**
	...
	public void mouseWheelMoved(MouseWheelEvent e) {
        ...
        if(accepted == true) {
            FXVisualizationViewer vv = (FXVisualizationViewer)e.getSource();
