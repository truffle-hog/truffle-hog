...
/** 
 * 
 * FXAbstractModalGraphMouse is a FXPluggableGraphMouse class that
 ...
 * @author Tom Nelson
 */
public abstract class FXAbstractModalGraphMouse extends FXPluggableGraphMouse
    ...
    protected FXAbstractModalGraphMouse(float in, float out) {
		this.in = in;
		this.out = out;
	}
    ...
    /* (non-Javadoc)
     * @see edu.uci.ics.jung.visualization.control.FXModalGraphMouse#setPickingMode()
     */
