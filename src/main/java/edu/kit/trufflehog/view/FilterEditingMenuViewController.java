 ...
 *     if you are really sure that you want to quit the app. It is used to create new Filters or update existing ones.
 * </p>
 *
 * @author Julian Brendl
 * @version 1.0
 */
public class FilterEditingMenuViewController extends AnchorPaneInteractionController<FilterInteraction> {
     ...
     */
    public FilterEditingMenuViewController(final String fxml,
