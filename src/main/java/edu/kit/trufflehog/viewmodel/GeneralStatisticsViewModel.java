...
public class GeneralStatisticsViewModel {
    ...
    private static final Logger logger = LogManager.getLogger(GeneralStatisticsViewModel.class);

    private final TreeItem<GeneralStatisticsViewModel.IEntry<StringProperty, ? extends Property>> rootItem = new TreeItem<>(new StringEntry<>("Info", ""));

    private final ListProperty<TreeItem<
                    GeneralStatisticsViewModel.IEntry<
                            StringProperty, ? extends  Property>>> infoListProperty = new SimpleListProperty<>(rootItem.getChildren());

    public TreeItem<GeneralStatisticsViewModel.IEntry<StringProperty, ? extends Property>> getRootItem() {
        return rootItem;
    }

    public ListProperty<TreeItem<GeneralStatisticsViewModel.IEntry<StringProperty, ? extends  Property>>> getInfoListProperty() {
