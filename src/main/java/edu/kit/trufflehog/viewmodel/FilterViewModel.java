...
public class FilterViewModel {
    ...
    public FilterInput updateFilter(final FilterInput oldFilterInput,
        ...
        if (filterInputUpdated.isAuthorized() != oldFilterInput.isAuthorized()) {
            oldFilterInput.getAuthorizedProperty().setValue(filterInputUpdated.getAuthorizedProperty().getValue());
        }
