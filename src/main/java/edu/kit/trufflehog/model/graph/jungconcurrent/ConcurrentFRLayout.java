 ...
 */
public class ConcurrentFRLayout<V, E> extends ConcurrentAbstractLayout<V, E> implements IterativeContext {
    ...
    private Map<V, FRVertexData> frVertexData =
            LazyMap.decorate(new HashMap<>(), (Factory<FRVertexData>) () -> {
     ...
     */
    public ConcurrentFRLayout(Graph<V, E> g) {
        super(g);
    }
     ...
     */
    public ConcurrentFRLayout(Graph<V, E> g, Dimension d) {
