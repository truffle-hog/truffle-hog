 ...
 * @param <E>
 */
public class ConcurrentStaticLayout<V, E> extends ConcurrentAbstractLayout<V,E> {

    /**
     * Creates an instance for the specified graph, locations, and size.
     */
    public ConcurrentStaticLayout(Graph<V,E> graph, Transformer<V,Point2D> initializer, Dimension size) {
     ...
     */
    public ConcurrentStaticLayout(Graph<V,E> graph, Transformer<V,Point2D> initializer) {
     ...
     */
    public ConcurrentStaticLayout(Graph<V,E> graph) {
        super(graph);
    }
     ...
     */
    public ConcurrentStaticLayout(Graph<V,E> graph, Dimension size) {
        super(graph, size);
    }
