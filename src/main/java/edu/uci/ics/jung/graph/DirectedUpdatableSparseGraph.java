...
public class DirectedUpdatableSparseGraph<V,E> extends AbstractTypedGraph<V, E> implements
        DirectedGraph<V, E>
{
    /**
   ...
   public static final <V,E> Factory<DirectedGraph<V,E>> getFactory() {
        return new Factory<DirectedGraph<V,E>> () {
            public DirectedGraph<V,E> create() {
                return new DirectedUpdatableSparseGraph<V,E>();
            }
        };
    }
     ...
     * Creates an instance.
     */
    public DirectedUpdatableSparseGraph()
    {
